...
class MySpider(CrawlSpider):
    name = 'wikispider'
    allowed_domains = ['wikipedia.org']  # Replace with your domain
    start_urls = ['https://en.wikipedia.org/wiki/Computer_science']
    visited_urls = set()
    pages_scraped = 0
    ...
    def parse_item(self, response: HtmlResponse):
        ...
        file_path = f"wikipediafiles/{sanitized_filename}.br"
        with open(file_path, 'wb') as file:
            file.write(compressed_html)
