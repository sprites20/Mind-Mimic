...
class MySpider(CrawlSpider):
    name = 'myspider'
    allowed_domains = ['geeksforgeeks.org']  # Replace with your domain
    ...
    def parse_item(self, response: HtmlResponse):
        ...
        file_path = f"geeksforgeeks/{sanitized_filename}.br"
        with open(file_path, 'wb') as file:
            file.write(compressed_html)
        ...
        # Print the number of pages scraped on the same line
